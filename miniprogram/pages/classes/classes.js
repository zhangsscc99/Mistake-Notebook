Page({
  ...
  ,async submitAssignment(e) { const id=e.currentTarget.dataset.id; const r=await this.call('submitAssignment',{assignmentId:id,answers:[]}); wx.showToast({title:r.success?'已提交':'提交失败',icon:r.success?'success':'none'}); }
});
