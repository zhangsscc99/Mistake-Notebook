...
Page({
  ...
  showPrivacyPolicy: function () {
    // 微信《用户隐私保护指引》要求写明注销渠道，所以这里必须提到学生/教师「我的 → 注销账号」。
    wx.showModal({
      title: '隐私政策',
      content: '本应用用微信 OpenID 区分账号，不读取微信头像、微信昵称或手机号。题目内容仅用于 AI 识别分析，不作他用，不向第三方共享。\n\n头像、昵称、学段由你在「我的」里自愿填写，仅保存在你的云端账号下。你可以随时在学生「我的」或教师「我的」中注销账号，自行清除全部云端数据，立即生效、不可恢复；也可通过「用户反馈」联系我们协助处理。',
      showCancel: false,
      confirmText: '了解'
    });
  },
