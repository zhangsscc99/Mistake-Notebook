Component({
  ...
  data: {
    tabs: [
      ...
      { key: 'capture', text: '拍照', url: '/pages/parentCapture/parentCapture', icon: '/images/tabbar/home.png', activeIcon: '/images/tabbar/home-active.png' },
      ...
      { key: 'chat', text: '对话', url: '/pages/parentChat/parentChat', icon: '/images/tabbar/chat.png', activeIcon: '/images/tabbar/chat-active.png' },
      { key: 'paper', text: '组卷', url: '/pages/parentPaper/parentPaper', icon: '/images/tabbar/edit.png', activeIcon: '/images/tabbar/edit-active.png' },
